                ...
                <table className="min-w-full bg-white">
                    ...
                    {operaciones.map((op) => (
                        <tr key={op.folio} className="border-b hover:bg-gray-100 cursor-pointer" onClick={() => setSelectedOperation(op)}>
                            <td className="py-2 px-4 font-mono text-sm">{op.folio}</td>
                            <td className="py-2 px-4">{op.vendedor_nombre}</td>
                            <td className="py-2 px-4">{op.comprador}</td>
                            <td className="py-2 px-4 text-sm">{op.fecha_creacion.substring(0, 10)}</td>
                            <td className="py-2 px-4 text-sm">{op.fecha_expiracion}</td>
                            ...
                            <td className="py-2 px-4 font-semibold">${parseFloat(op.costo).toFixed(2)}</td>
                            <td className="py-2 px-4">
    ...
    return (
        <>
            <div className="bg-gray-100 min-h-screen">
                <header className="bg-white shadow-sm no-print">
                    <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                        ...
                        <div>
                            ...
                            {user && <span className="text-sm text-gray-500">Usuario: {user.username} ({user.role})</span>}
                        </div>
                ...
                <main className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8 no-print">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
                            ...
                            <div>
                                ...
                                <select name="estado" value={filters.estado} onChange={handleFilterChange} className="mt-1 block w-full rounded-md p-2 border-gray-300 shadow-sm">
                                    ...
                                    <option value="en_resguardo">En resguardo</option><option value="entregado">Entregado</option>
                                    <option value="cancelado">Cancelado</option><option value="expirado">Expirado</option>
                                </select>
                            </div>
                            <div>
